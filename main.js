...
productos.forEach(producto => {
    ...
    productoCarrito.classList.add('producto__carrito');
    const carritoTexto = document.createElement('h2');
    carritoTexto.textContent = 'Agregar';
    const carritoImg = document.createElement('img');
    carritoImg.src = '../assets/img/cart.svg';
    carritoImg.alt = 'cart';
    productoCarrito.appendChild(carritoTexto);
    productoCarrito.appendChild(carritoImg);
    ...
    productoListado.appendChild(productoCarrito);
